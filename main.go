...
// can be customized.
//go:generate go run github.com/hashicorp/terraform-plugin-docs/cmd/tfplugindocs generate -provider-name terraform-provider-exampletime-vkvk
...
import (
	...
	"terraform-provider-exampletime-vkvk/internal/provider"
)
...
func main() {
	...
	opts := providerserver.ServeOpts{
		...
		// as registry.terraform.io/hashicorp/exampletime. This specific
